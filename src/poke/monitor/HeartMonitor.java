...
public class HeartMonitor {
	...
	// protected ChannelFactory publicCF;
	...
	/**
	 * this is used for demonstrations as it creates a handler to print heartbeatMgr
	 * messages.
	 * 
	 * @param host
	 *            the hostname
	...
	public void release() {
		...
		// if (publicCF != null)
		// publicCF.releaseExternalResources();
	}
	...
	/**
	 * for demonstration - this will enter a loop waiting for heartbeatMgr messages.
	 * 
